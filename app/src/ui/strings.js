...
export const strings = Object.freeze({
  ...
  course: {
    title: 'The course',
    unavailable: 'The course is still loading.',
    currentUnit: 'You are here',
    startLesson: 'Start unit',
    continueLesson: 'Continue unit',
    startCheckpoint: 'Take the checkpoint',
    introducedOf: (n, total) => `${n} of ${total} words`,
    cleared: 'Cleared',
    gold: 'Gold',
  ...
  syllabus: {
    ...
    // A recurring topic, numbered as a series so no two rows read the same.
  ...
  lesson: {
    ...
    sittingDone: 'Nice work',
    unitReady: 'Unit ready',
    taught: (n) => (n === 1 ? 'One new word, met and practised.' : `${n} new words, met and practised.`),
    nothingNew: 'Practised what you have met.',
  ...
  exercise: {
    ...
    wrong: 'Not quite',
    answerLabel: 'Answer: ',
    theAnswer: (a) => `Answer: ${a}`,
    continue: 'Continue',
    check: 'Check',
    playPrompt: '▶ Play',
    typePinyin: 'Type the pinyin',
    matchPrompt: 'Match each character to its meaning.',
